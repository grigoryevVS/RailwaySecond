<%--<div class="masthead">--%>
    <%--<div class="row">--%>
        <%--<div class="span3">--%>
            <%--<h3 class="muted"><a class="icon-adjust" href="${pageContext.request.contextPath}/index">SBB CFF FFS</a></h3>--%>
        <%--</div>--%>
        <%--<div class="span4">--%>
            <%--<a href="${pageContext.request.contextPath}/index"><img class="img-rounded" src="/RailWay/images/train2.jpg"></a>--%>
        <%--</div>--%>
