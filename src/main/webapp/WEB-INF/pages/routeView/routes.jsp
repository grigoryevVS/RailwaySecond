                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn-my btn-small btn-success"
                                    onclick="location.href='updateRoute/${route.routeId}'">update
                            </button>
                            <button class="btn-my btn-small btn-success"
                                    onclick="getModal('/RailWay/routeView/delete/${route.routeId}/')">delete
                            </button>
                            <button class="btn-my btn-small btn-info"
                                    onclick="location.href='details/${route.routeId}'">details
                            </button>
                        </td>
                    </tr>
                </c:forEach>
